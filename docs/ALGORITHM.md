...
**Tools used:** `get_issue_resolution`, `get_pr_details`, `score_pr_confidence`, `verify_pr_match`.
...
**Tools used:** `filter_relevant_entries`, `get_pr_details`, `score_pr_confidence`, `verify_pr_match`.
